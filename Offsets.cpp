...
namespace offsets
{
    ...
    const long LAST_CROSSHAIR_TIME = 0x1A82;        // [Miscellaneous]                  -> CPlayer!lastCrosshairTargetTime
    ...
    const long ZOOM_FOV = (0x16c0 + 0xb8)           // [DataMap.WeaponPlayerData]             -> m_playerData + m_curZoomFOV
}
